...
2. Save it and run.
3. When the page is loaded the value "H4 Text = Heading 4", will be the heading that is displayed and "Class = h4" is the class name that can be used to point to a class in a style sheet.
...
* **H4 Text:** Specifies the text to be displayed inside the heading.
